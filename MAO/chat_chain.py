...
class ChatChain:
    ...
    def post_processing(self):  
        ...
        post_info += "MAO Ends ({})".format(now_time) + "\n\n"
        ...
        # os.system("cd {} && git add .".format(self.chat_env.env_dict["directory"]))
        # os.system("cd {} && git commit -m \"v{} Final Version log commit\"".format(self.chat_env.env_dict["directory"], self.chat_env.codes.version))
